...
def import_income_xlsx(
    ...
    *,
    ...
    date_col = find_column(normalized_columns, ColumnMatch(name="data", candidates=("data", "date")))
    ...
    amount_col = find_column(normalized_columns, ColumnMatch(name="valor", candidates=("valor", "amount")))
    category_col = find_column(normalized_columns, ColumnMatch(name="categoria", candidates=("categoria", "category")))
    subcategory_col = find_column(normalized_columns, ColumnMatch(name="subcategoria", candidates=("subcategoria", "sub-category", "sub_category")))
